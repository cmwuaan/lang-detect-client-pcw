 ...
 *
 *   node scripts/build-node.js                         # target của máy đang chạy
 *   node scripts/build-node.js x86_64-apple-darwin     # target cụ thể
 *
 ...
 * chuỗi cung ứng) vào repo. Cờ link cho napi do napi-build lo trong build.rs.
 */
 ...
 *
 * Bài học từ `zwalker` trong repo này: binary commit vào mà không có source lẫn
 * thông tin toolchain là hộp đen — không ai trả lời được nó dựng bằng gì, và hoá
 * ra nó mang sẵn lỗi Windows 7 mà không ai biết.
 */
